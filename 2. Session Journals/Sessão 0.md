...
# Sessão 0: Preparativos para a Aventura

Esta sessão é dedicada a alinhar expectativas, estabelecer regras da mesa, introduzir o mundo e, se necessário, criar os personagens. É um momento crucial para garantir que todos estejam na mesma página e prontos para a jornada que se inicia.

## *I. Introduções & Quebra-Gelo*

*   **Apresentações:**
    *   Nomes (reais e preferenciais, se houver).
    *   Experiência com RPGs (ou com o tipo de projeto).
    *   O que cada um espera desta campanha/projeto.
    *   Uma curiosidade ou algo divertido sobre si.

## *II. O Jogo & O Mundo*

*   **Sistema de Jogo:**
    *   ==Qual RPG será jogado (ex: D&D 5e, Call of Cthulhu, Cyberpunk RED, etc.).==
	    * Nós vamos jogar DnD 5e (2014 e 2024)
    *   ==Breve resumo das mecânicas principais.==
	    * Vamos ter um documento de [[House Rules]] para documentar todas as regras alternativas que vamos usar
    *   ==Recursos disponíveis (livros, PDFs, ferramentas online).==
	    * D&D Beyond. Vou compartilhar todos os Meus Conteúdos 
		    * Baixar o aplicativo de celular que pode ser útil caso queiram usar como 
